...
public class Main {
    ...
    public Main()
    {
        ...
        CSProcess[] procList = { 
            new Producer(prodChan[0].out(), 0), new Producer(prodChan[1].out(), 100), new Buffer(prodChan, consReq, consChan),
            new Consumer(consReq[0].out(), consChan[0].in()), new Consumer(consReq[1].out(), consChan[1].in()) 
        }; 
