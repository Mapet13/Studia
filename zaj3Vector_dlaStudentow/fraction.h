...
class Fraction {
   public:
    ...
    [[nodiscard]] auto numerator() const noexcept { return numerator_; }
    [[nodiscard]] auto denominator() const noexcept { return denominator_; }
   ...
   private:
    ...
    [[nodiscard]] Fraction getReduced() const noexcept;

    static constexpr auto invalid_denominator_value{ 0 };
};
