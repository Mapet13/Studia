...
constexpr const char* const SURNAME   = "Sordyl";
constexpr const char* const MAIL    = "jsordyl@student.agh.edu.pl";
constexpr const char* const BOOK_ID = "406510";
constexpr const char* const TEACHER_MAIL = "bmaj[at]agh.edu.pl"; // change if not correct
